...
int main()
{
	try {
		...
		//Expected output:
		//9. 2 + 3 + 4, \n is ignored and delim is accepted as the delimiter
		//3. 1001 is ignored (over the 1000 limit), 1\n1 is converted to 1 since \n is invalid but not a delimiter
		//7. the ] character invalidates the initial 2 resulting in 0 + 3 + 4
	}
